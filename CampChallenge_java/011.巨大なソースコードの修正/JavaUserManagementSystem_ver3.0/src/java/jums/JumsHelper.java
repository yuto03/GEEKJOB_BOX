...
public class JumsHelper {
    ...
    //登録ページへのリンクを定数として設定
    private final String recordURL = "insert.jsp";
    private final String searchURL = "search.jsp";
    private final String deleteURL = "delete.jsp";
    ...
    public String insert(){
        return "<a href=\""+recordURL+"\">登録画面へ</a>";
    }
    //検索ページへのリンクを返却
    public String search(){
        return "<a href=\""+searchURL+"\">検索画面へ</a>";
    }
    public String delete(){
        return "<a href=\""+deleteURL+"\"></a>";
    }
    /**
