 ...
 * @author osakayuto
 */
public class processRequest5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db_con = DriverManager.getConnection("jdbc:mysql://localhost:8889/challeng_db", "challeng1", "pass");
                ...
                db_st = db_con.prepareStatement("select * from user where name like '%茂%' ");
//            mysqlから受け取った値をexecuteQueryで実行
                ...
                while(db_data.next()){
                    ...
                    out.print("所属ID："+db_data.getInt("departmentID"));
                    out.print("勤務地："+db_data.getInt("stationID")+"<br>");
                }
