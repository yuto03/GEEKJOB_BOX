 ...
 * @author osakayuto
 */
public class processRequest11 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db_st = db_st = db_con.prepareStatement("update user set name=?,tell=?,age=?,birthday=?,departmentID=?,stationID=? where userID = ?");
