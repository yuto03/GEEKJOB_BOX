 ...
 * @author osakayuto
 */
public class processRequest13_3 extends HttpServlet {
...
z     * @param response servlet response
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db_st = db_con.prepareStatement("select * from ItemProfile");
           ...
           db_data= db_st.executeQuery();
            while(db_data.next()){
            out.print("ItemID："+db_data.getInt("itemID")+"<br>") ;
            out.print("商品名："+db_data.getString("name")+"<br>");
            out.print("個数："+db_data.getInt("num")+"<br>");
            out.print("価格："+db_data.getInt("price")+"<br>");
