 ...
 * @author osakayuto
 */
public class processRequest13 extends HttpServlet {
...
z     * @param response servlet response
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db_st = db_con.prepareStatement("select * from record where NAME = ?  and password = ?");
            db_st.setString(1,userID);
            db_st.setInt(2,password);
           
           
                                                /*
                                                userIDとpasswordが合っていれば
                                                db_data.next()がtrueでlogin.javaページに飛ぶ

                                                userIDとpasswordが合ってなければ
                                                db_data.next()がfalseでログインフォームがあるページへ飛ぶ
↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓                                                 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
           ...
           /////////////
            if(db_data.next() == true){
                ...
                session.getAttribute(target);//("target",taarget
                response.sendRedirect("iteminfo.jsp");
            }else{

            session.setAttribute("status", "Not");
            response.sendRedirect("sessionlog");
